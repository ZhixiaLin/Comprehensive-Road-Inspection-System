...
-- ----------------------------
BEGIN;
INSERT INTO `regular_smooth` VALUES (65001, '纪欢', '潮王路', '66', '2024-11-01', '世界聚焦于你');
INSERT INTO `regular_smooth` VALUES (65002, '王婷', '潮王路', '66', '2024-12-04', '世界聚焦于你');
...
-- 创建道路基础信息表
CREATE TABLE RoadBasicInformation (
                                      roadId INT PRIMARY KEY NOT NULL COMMENT '道路的唯一标识',
                                      roadName VARCHAR(50) NOT NULL COMMENT '道路的名称'
);
...
-- ----------------------------
-- Records of RoadBasicInformation
-- ----------------------------
BEGIN;
INSERT INTO RoadBasicInformation VALUES (1, '潮王路');
INSERT INTO RoadBasicInformation VALUES (2, '朝晖路');
INSERT INTO RoadBasicInformation VALUES (3, '文一路');
INSERT INTO RoadBasicInformation VALUES (4, '莫干山路');
INSERT INTO RoadBasicInformation VALUES (5, '德胜路');
INSERT INTO RoadBasicInformation VALUES (6, '学院路');
INSERT INTO RoadBasicInformation VALUES (7, '湖州街');
INSERT INTO RoadBasicInformation VALUES (8, '石祥路');
INSERT INTO RoadBasicInformation VALUES (9, '拱墅路');
INSERT INTO RoadBasicInformation VALUES (10, '沈半路');
COMMIT;
